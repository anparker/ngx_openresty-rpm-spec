...
Third, copy or download source files into correct folders:
	...
	curl -o ./rpmbuild/SOURCES/openresty-1.13.6.2.tar.gz  https://openresty.org/download/openresty-1.13.6.2.tar.gz
...
To install the resulting RPM and all the RPM dependencies:
	...
	yum -y install ./rpmbuild/RPMS/x86_64/openresty-1.13.6.2-1.el7.centos.x86_64.rpm
